...
import img1 from "./project2-1.png";
import img2 from "./project2-2.png";
import img3 from "./project2-3.png";
import img4 from "./project2-4.png";
import img5 from "./project2-5.png";
import img6 from "./project2-6.png";
import img7 from "./project2-7.png";
import img8 from "./project2-8.png";
import img9 from "./project2-9.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>
          Box8 is a Online food ordering website where you can order different items of food through 
          online.You can filter the food items by category, by food Name
          etc..You can add the food items in cart-page and wishlist then order the food items
          by checking out.
        </p>
