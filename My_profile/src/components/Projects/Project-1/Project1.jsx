...
import img1 from "./project1-1.png";
import img2 from "./project1-2.png";
import img3 from "./project1-3.png";
import img4 from "./project1-4.png";
import img5 from "./project1-5.png";
import img6 from "./project1-6.png";
import img7 from "./project1-7.png";
import img8 from "./project1-8.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        >
          American_Eagle clone
        </h2>
        <p>
          American Eagle is an E-commerce website where you can buy new American Eagle Branded Clothes
          online.You can filter the dresses by costs, Price Range
