...
import img1 from "./project3-1.png";
import img2 from "./project3-2.png";
import img3 from "./project3-3.png";
import img4 from "./project3-4.png";
import img5 from "./project3-5.png";
  ...
  return (
    <div className={style.project1body}>
      ...
      <div className={style.procontentdiv}>
        ...
        <p>React | CSS | JavaScript | Mongo DB | Express JS | Node JS | MaterialUI | React-slick</p>
        ...
        <div className={style.btndivv}>
          <button className={style.btnpro} style={{ backgroundColor: "black" }}>
            <a
              ...
              target="_blank"
              href="https://github.com/saitej98/coursera-clone"
            >
              <span>
                <svg
                  style={{
          ...
          >
            <a
              ...
              style={{ textDecoration: "none", color: "white" }}
              target="_blank"
              href="https://coursera-clones.vercel.app/"
            >
              <span>
                <svg
                  style={{
